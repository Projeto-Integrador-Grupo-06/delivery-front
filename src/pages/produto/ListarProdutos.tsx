...
function ListaProdutos() {
    ...
    const [produtosNormais, setProdutosNormais] = useState<(Produto & { id?: string | number })[]>([]);
    ...
    useEffect(() => {
        ...
        // Remove os produtos veganos e orgânicos da lista principal
        const normais = produtos.filter(
            (produto) =>
                !produto.categoria?.categoriaVegano &&
                !produto.categoria?.categoriaOrganico
        );

        setProdutosNormais(normais);
        ...
        <div className="w-full bg-[#F0E7D6] py-4">
            ...
            <div className="flex justify-center w-full">
                <div className="container flex flex-col">
                    ...
                    {/* PRODUTOS NORMAIS */}
                    {!isLoading && produtosNormais.length > 0 && (
                        <>
                            <h2
                                className="text-2xl uppercase text-[#D22519] mb-6"
                                style={{ fontFamily: "'Julius Sans One', sans-serif" }}
